...
class Order(models.Model):
    ...
    ORDER_DELIVERED = 3
    ORDER_REJECTED = 4
    STATUS_CHOICES = ((CART_STAGE,'Cart_Stage'),(ORDER_CONFIRMED,'Order_Confirmed'),(OREDER_PROCESSED,'Order_Processed'),(ORDER_DELIVERED,'Order_Delivered'),(ORDER_REJECTED,'Order_Rejected'))
